/*
 *
 * SnapshotOnDemandBootstrapInstanceInformationProvider.java
 *
 *-----------------------------------------------------------------------------
...
public class SnapshotOnDemandBootstrapInstanceInformationProvider extends AbstractOnDemandBootstrapInstanceInformationProvider
{
    private static Logger log = LoggerFactory.getLogger(SnapshotOnDemandBootstrapInstanceInformationProvider.class);

    @Configuration("com.dowdandassociates.gentoo.bootstrap.BootstrapInstance.snapshotId")
    private Supplier<String> snapshotId = Suppliers.ofInstance(null);
    ...
    @Inject
    public SnapshotOnDemandBootstrapInstanceInformationProvider(
            AmazonEC2 ec2Client,
